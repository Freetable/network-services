...
CREATE PROCEDURE add_file_to_network (fid CHAR(128), rh CHAR(128), ttitle VARCHAR(128), aartist VARCHAR(128), aalbum VARCHAR(128), yyear DATE, mmd5 CHAR(32), ssha1 CHAR(160), ssha512 CHAR(128))
BEGIN
